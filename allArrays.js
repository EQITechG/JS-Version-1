...
const smallNumbers = bigNumbers.map(numbers =>{return numbers/100});
...
//Filter creates a new array after filtering//
/*+++++++++++++++++++++++*/
...
//Filtering a string in arrays, can also be done with .charAt(0)//
const animals = ['hippo', 'tiger', 'lion', 'seal', 'cheetah', 'monkey', 'salamander', 'elephant'];
const foundAnimal = animals.findIndex(animal =>{return animal === 'elephant'});
const startsWithS = animals.findIndex(s =>{return s.charAt(0)==='s';});
